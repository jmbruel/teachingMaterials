...
=== US {us-icons} vs FR {fr-icon}

{fr-icon} Ce site est en anglais pour permettre une plus large diffusion.
...
The following courses are in English except those with the French flag {fr-icon}.
