= Teaching materials image:{baseURL}/workflows/Checks/badge.svg[Checks] image:{baseURL}/workflows/Tests/badge.svg[Tests]
...
WARNING: Site under construction!! Please look at the published version : {website}/index.html.
...
[cols="1,1,4,6"]
|===
| {git}  | {beginner} {cogs-icon} {fr-icon}| link:git.adoc[source] link:git.html[HTML] link:git.slides.html[slides] link:git.pdf[PDF] 
| Basic of {git} principles and commands

| Scrum  | {beginner} {graduation-icon} {fr-icon}| link:scrum.adoc[source] link:scrum.html[HTML] link:scrum.slides.html[slides] link:scrum.pdf[PDF] 
| Basic of the Scrum agile method

| Refactoring  | {advanced} {graduation-icon} {us-icon}| link:refactoring.adoc[source] link:refactoring.html[HTML] link:refactoring.slides.html[slides] link:refactoring.pdf[PDF] 
