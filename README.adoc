...
[cols="1,1,4,6"]
|===
| LP-DAM-IOTIA  | {advanced} {cogs-icon} {us-icon}| link:intro.adoc[source] link:intro.html[HTML]
| Introduction to the 2018-2021 GL course.

| BCOO (M2105)  | {beginner} {cogs-icon} {fr-icon}| link:http://iut-blagnac.github.io/POO/[Web Page] link:intro.html[HTML]
