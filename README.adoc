...
:us-icon: image:icons/usa.svg[width=30%]
:fr-icon: image:icons/france.svg[width=30%]
...
[cols="1,1,4,6"]
|===
| {git}  | {beginner} {fr-icon}| link:git.adoc[source] link:git.html[HTML] link:git.slides.html[slides] link:git.pdf[PDF] 
