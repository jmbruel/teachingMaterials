...
| Continuous Integration | {graduation-icon} {cogs-icon} {fr-icon}| link:ci-fr.adoc[source] link:ci-fr.html[HTML]  link:ci-fr.pdf[PDF] 
| Principles of CI (mainly GitLab)

| Continuous Integration | {graduation-icon} {cogs-icon} {us-icon}| link:ci.adoc[source] link:ci.html[HTML]  link:ci.pdf[PDF] 
