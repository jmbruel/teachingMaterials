= Teaching materials image:{baseURL}/workflows/Checks/badge.svg[Checks] image:{baseURL}/workflows/Tests/badge.svg[Tests] image:https://api.codacy.com/project/badge/Grade/550a9c47c3d6426c9122765e45097a3c[link="https://app.codacy.com/gh/jmbruel/teachingMaterials?utm_source=github.com&utm_medium=referral&utm_content=jmbruel/teachingMaterials&utm_campaign=Badge_Grade"] image:https://sonarcloud.io/api/project_badges/measure?project=jmbruel_teachingMaterials&metric=sqale_index
[Technical Debt,link="https://sonarcloud.io/api/project_badges/measure?project=jmbruel_teachingMaterials&metric=sqale_index
"]
