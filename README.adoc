...
| Introduction to the Software Engineering course. | since 2018

| https://www.iut-blagnac.fr[DUT INFO] : https://webetud.iut-blagnac.fr/course/view.php?id=352[BCOO (M2105)]  | {beginner} {cogs-icon} {fr-icon}| link:http://iut-blagnac.github.io/POO/[Web Page] link:intro.html[HTML]
...
If you want to contribute, read link:CONTRIBUTING.adoc[this].
